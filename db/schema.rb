...
ActiveRecord::Schema.define(version: 2020_03_29_170647) do
  ...
  create_table "pricing_rule_orders", force: :cascade do |t|
    t.bigint "pricing_rule_id"
    t.bigint "order_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["order_id"], name: "index_pricing_rule_orders_on_order_id"
    t.index ["pricing_rule_id"], name: "index_pricing_rule_orders_on_pricing_rule_id"
  end
  ...
  add_foreign_key "pricing_rule_orders", "orders"
  add_foreign_key "pricing_rule_orders", "pricing_rules"
